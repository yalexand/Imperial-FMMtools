classdef FMMtools_profile_controller
...
%             profile_def.Export.Plotter_Width_Px = 400;
    ...
    methods
        ...
        function obj = FMMtools_profile_controller_profile_controller()
            folder = getapplicationdatadir('FMMtools',true,true);
            subfolder = [folder filesep 'Profiles']; 
            if ~exist(subfolder,'dir')
                mkdir(subfolder)
            end
            obj.profile_file = [ subfolder filesep 'FMMtoolsPrefs.mat' ];
        end
        ...
        function set_profile(obj)
            ...
            set(f,'Name','FMMtools Preferences',...
                  'NumberTitle', 'off', ...
                  'Toolbar','none',...
                  'MenuBar','none');
